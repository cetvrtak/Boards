defmodule VisionWeb.ListLiveTest do
  ...
  @create_attrs %{tasks: [], title: "some title"}
  @update_attrs %{tasks: [], title: "some updated title"}
  @invalid_attrs %{tasks: nil, title: nil}
